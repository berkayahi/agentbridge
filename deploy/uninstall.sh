...
systemctl --user disable --now agentbridge.service agentbridge-backup.timer 2>/dev/null || true
rm -f -- "$unit_dir/agentbridge.service" "$unit_dir/agentbridge-backup.service" \
